...
for(en in 1:3){
 ...
 d1 = readRDS(paste0("Simulation_Study_1/DENS/dens_list_skip_ngroups_",gr,"_samplesize_",en,"_sub_ALL.RDS"))
 d2 = readRDS(paste0("Simulation_Study_1/DENS/dens_list_2pbp_ngroups_",gr,"_samplesize_",en,"_sub_ALL.RDS"))
...
saveRDS(data_skip,"Simulation_Study_1/RDS/data_skip.RDS")
saveRDS(data_2pbp,"Simulation_Study_1/RDS/data_2pbp.RDS")
...
ggsave("Simulation_Study_1/OUTPUT/D1_skip_KL.pdf",h=9,w=12)
ggsave("Simulation_Study_1/OUTPUT/D1_skip_KL.eps",h=9,w=12)
...
ggsave("Simulation_Study_1/OUTPUT/D1_skip_JS.pdf",h=9,w=12)
ggsave("Simulation_Study_1/OUTPUT/D1_skip_JS.eps",h=9,w=12)
...
ggsave("Simulation_Study_1/OUTPUT/D1_skip_TV.pdf",h=9,w=12)
ggsave("Simulation_Study_1/OUTPUT/D1_skip_TV.eps",h=9,w=12)
...
ggsave("Simulation_Study_1/OUTPUT/D1_2pbp_KL.pdf",h=9,w=12)
ggsave("Simulation_Study_1/OUTPUT/D1_2pbp_KL.eps",h=9,w=12)
...
ggsave("Simulation_Study_1/OUTPUT/D1_2pbp_JS.pdf",h=9,w=12)
ggsave("Simulation_Study_1/OUTPUT/D1_2pbp_JS.eps",h=9,w=12)
...
ggsave("Simulation_Study_1/OUTPUT/D1_2pbp_TV.pdf",h=9,w=12)
ggsave("Simulation_Study_1/OUTPUT/D1_2pbp_TV.eps",h=9,w=12)